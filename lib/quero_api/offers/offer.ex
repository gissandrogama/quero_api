defmodule QueroApi.Offers.Offer do
  @moduledoc """
  this is a schema **offers** module with the function to verify data integrity
  """
  use Ecto.Schema
  ...
  schema "offers" do
    ...
    many_to_many :courses, QueroApi.Courses.Course,
      join_through: QueroApi.CoursesOffers.CoursesOffer
